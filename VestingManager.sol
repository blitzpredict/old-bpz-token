...
contract VestingManager is BaseContract, Owned, TokenRetriever {
    ...
    /// @param _bpz BPZSmartToken The address of the previously deployed BPZSmartToken smart contract.
    function VestingManager(BPZSmartToken _bpz)
        public
    {
        require(_bpz != address(0));
